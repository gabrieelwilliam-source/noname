(function () {
  ...
  var scenarios = {
    comprador: {
      ...
      description: 'Informe seu perfil de compra para receber opções compatíveis.',
    ...
    aluguel: {
      ...
      description: 'Informe sua necessidade de locação para a equipe indicar opções.',
    ...
    visita: {
      ...
      title: 'Tenho interesse em visitar', description: 'Envie seus dados para combinar próximos passos sobre este imóvel.',
    ...
    investimento: {
      ...
      title: 'Quero investir em imóvel', description: 'Informe seu objetivo para receber opções com potencial de renda.',
  ...
  function bootFromStorage() {
    var key = '';
    try { key = localStorage.getItem('lais_imob_journey') || ''; localStorage.removeItem('lais_imob_journey'); } catch (e) {}
